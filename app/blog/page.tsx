...
export const metadata: Metadata = {
  title: 'Блог о фундаментах и домах из газобетона · ' + SITE.name,
  description:
    'Экспертные статьи СК «Юрьевич»: плитные фундаменты, дома из газобетона, грунты Ленобласти, технологии работ. Только проверенная практика — без воды.',
  alternates: { canonical: '/blog/' },
  openGraph: {
    title: 'Блог о фундаментах и домах из газобетона',
    description:
      'Экспертные статьи СК «Юрьевич»: фундаменты, газобетон, грунты Ленобласти.',
    url: `${SITE.url}/blog/`,
    type: 'website',
  },
};
