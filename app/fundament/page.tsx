...
export const metadata: Metadata = {
  title: 'Фундамент под ключ в СПб и Ленобласти — цена от 5 500 ₽/м², расчёт по районам',
  description:
    'Монолитный плитный фундамент под ключ в Санкт-Петербурге и Ленинградской области от 5 500 ₽/м². ' +
    'Выберите район — знаем местные грунты и реальные цены. Бетон М300, гарантия 5 лет, договор с фикс-ценой. ' +
    'Бесплатный расчёт и выезд инженера. ☎ +7 911 830-01-10',
  keywords: [
    ...
    'фундамент Ленинградская область',
    ...
    <>
      ...
      <section className="container-x pt-10 md:pt-14 pb-6">
        ...
        <h1 className="text-3xl md:text-5xl font-extrabold leading-tight tracking-tight max-w-3xl">
          Фундамент под ключ в СПб и Ленобласти — плита, лента, сваи
        </h1>
