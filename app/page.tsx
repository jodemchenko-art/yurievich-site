...
export const metadata = {
  // Wordstat, СПб + ЛО, замер 14.08.2026: «фундамент под ключ» 1491, «ленточный фундамент» 6490,
  // «монолитный фундамент» 1549 — против 55 у «фундамент на пучинистых грунтах».
  // Заголовок был построен вокруг фразы, которую ищут в 27 раз реже. Тема пучины осталась в тексте.
  title: 'Фундамент под ключ СПб: плита, лента, сваи — от 5 500 ₽/м²',
  description:
    'Монолитный фундамент под ключ в СПб и Ленобласти: плита, лента, сваи. ' +
    'Цена от 5 500 ₽/м², выезд инженера бесплатно, договор с фикс-ценой, гарантия 5 лет. ' +
    '239 объектов, ★5 (35 отз). Смета в Telegram.',
