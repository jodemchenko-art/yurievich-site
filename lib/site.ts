export const SITE = {
  ...
  // === Contact ===
  // Телефон на страницах НЕ показывается (решение 02.09.2026 — только мессенджеры).
  // Остаётся в Schema.org / микроразметке: этот же номер стоит в Я.Картах и 2ГИС,
  // и расхождение NAP там ударило бы по локальному SEO.
  phone: '+7 911 830-01-10',
  phoneRaw: '+79118300110',
  email: 'yurademko707@yandex.ru',
  // 🔴 02.09.2026: контакты сведены к двум мессенджерам — Telegram и MAX.
  // WhatsApp и сообщество ВКонтакте убраны с сайта полностью.
  // Номера телефонов НЕ показываем: на сайте только кликабельные ссылки в мессенджер.
