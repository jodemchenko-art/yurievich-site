...
export default function FaqBlock() {
  return (
    <section id="faq" data-plane="paper" className="relative overflow-hidden bg-paper0">
      ...
      <div className="container-x relative py-16 md:py-24">
        ...
        <div className="mt-10 max-w-4xl border-t border-rule md:mt-14">
          {HOME_FAQ.map((f, i) => (
            <details
              key={f.q}
            ...
            >
              <summary className="flex items-start gap-4 py-4 md:py-5">
                <span className="mono mt-1 flex-shrink-0 text-[11px] text-sand">
                ...
                <span
                  aria-hidden
                  className="faq-sign mono mt-0.5 flex-shrink-0 text-lg leading-none text-inkmute"
                >
                  +
                </span>
              </summary>
              ...
              <div className="faq-body">
                <div className="overflow-hidden">
                  <p className="pb-5 pl-9 pr-8 text-sm leading-relaxed text-inkmute md:pl-10 md:text-[15px]">
                    {f.a}
                  </p>
                </div>
              </div>
