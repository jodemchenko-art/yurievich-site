      ...
      <div className="container-x">
        <div className="max-w-3xl">
          ...
          <p className="section-sub">
            Главное направление — монолитный плитный фундамент. По стенам и дому под ключ
            работаем только с газобетоном ЛСР. Никаких субподрядчиков — всё делаем своей бригадой.
          </p>
        </div>
