...
export default function Quiz() {
  ...
  const [contactType, setContactType] = useState<'call' | 'telegram' | 'max'>('call');
    ...
    return (
      ...
      <div className="border border-rule bg-paper0 p-8 text-graphite md:p-10">
        ...
        <ol className="mt-6 border-t border-hair">
          {[
            ['01', 'Юрий ответит сам', 'Обычно в течение часа в рабочее время — тем способом, который вы выбрали.'],
          ...
          <form onSubmit={submit}>
            ...
            <div className="mt-6 grid gap-4">
              ...
              <div>
                ...
                <div className={`mt-2 grid gap-2 ${SITE.max ? 'grid-cols-3' : 'grid-cols-2'}`}>
                  {(SITE.max
